...
### Note: 
Currently, this version of the repository does not contain the main business logic for security reasons. only the structure of the services themselves is presented here.
